                            ...
                            <div class="card-header">
                                <h3>
                                   ...
                                   @endif
                                    ...
                                    <a href="{{ route('view-size') }}" class="btn btn-primary float-sm-right"> 
                                        <i class="fa fa-list"></i> Size List</a>
                                </h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-hover">
                                    <form action="{{(@$editData)?route('update-size',$editData->id) : route('store-size')}}" method="post" id="myForm" enctype="multipart/form-data">
                                        @csrf 
                                        <div class="form-row">

                            ...
                            <div class="card-body">
                                <form action="{{ route('update-slider',$editData->id) }}" method="post" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <img id="showImage" src="{{(!empty($editData->image))?url('public/upload/slider_image/'.$editData->image):url('/upload/no-img.png')}}" style="height: 160px;width: 100%;border: 1px solid #000" alt="img">
                                        </div>
                                        <div class="form-group col-md-4">
